    ...
    try {
      ...
      if (userId) {
        ...
        await supabase.from('kyb_applications').insert({
          company_id: company.id, status: 'draft', step: 1
        })
      }
      navigate('/kyb/form')
    } catch (err) {
        ...
        <div className="card">
          ...
          <form onSubmit={handleSubmit}>
            <div className="input-group">
              ...
              <input className="input-field" name="company_name" value={form.company_name}
                onChange={handleChange} placeholder="Ej: Acme Corp LLC" required />
            </div>
            <div className="input-group">
              <label>Email Corporativo</label>
              <input className="input-field" type="email" name="email" value={form.email}
                onChange={handleChange} placeholder="tu@empresa.com" required />
            </div>
            <div className="input-group">
            ...
            <div className="input-group">
              ...
              <input className="input-field" type="password" name="confirm" value={form.confirm}
